        ...
        <div class="px-4 py-8 shadow-xl bg-gray-50 sm:rounded-lg sm:px-10">
            <div class="mb-6">
                ...
                <p class="mt-2 text-sm leading-5 text-center text-gray-600 max-w">
                    Sau
                    <a href="{{ route('login') }}" class="font-medium text-green-600 transition duration-150 ease-in-out hover:text-green-500 focus:outline-none focus:underline">
                        Intră într-un cont existent
                    </a>
                </p>
            </div>
            <form wire:submit.prevent="register">
                ...
                <div class="mt-6">
                    <span class="block w-full rounded-md shadow-sm">
                        <button type="submit" class="flex justify-center w-full px-4 py-2 text-sm font-medium text-white transition duration-150 ease-in-out bg-green-600 border border-transparent rounded-md hover:bg-green-500 focus:outline-none focus:border-green-700 focus:ring-green active:bg-indigo-700">
                            Înregistrare
                        </button>
                    </span>
                </div>
